...
import com.ablethon.woongsang.gestcapturex.ProcessGesture.ProcessDestinationGesture;
...
public class DestinationActivity extends Activity implements TextToSpeech.OnInitListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        CommonLibrary.initDestinationList();
        itemSelector = -1;
    ...
    AdapterView.OnTouchListener scrollChecker = new  AdapterView.OnTouchListener() {
        ...
        ProcessDestinationGesture pg= new ProcessDestinationGesture();                               //to prcessing gesture
    ...
    * */
    ...
    public void onInit(int status) {
        String myText1 = "위 아래로 드래그하여 목적지를 선택해주세요";
        String myText2 = "목적지로 설정 하시려면 좌에서 우로 드래그 해주세요";
